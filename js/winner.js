...
if (winner == "X"){
    ...
    ggText.innerHTML = `Lograste vencer al ingenuo caballero en ${turnosP1.contadorTurnosP1} turnos. Gracias a ello pudiste
    ...
    ggText.innerHTML = `Gracias a tu astucia, sólo necesitaste ${turnosP2.contadorTurnosP2} turnos para poder librar
